...
// using the fact that only one of ( and ) will be there
// we can deduce that only even length will be ans 
// also we don't need to find the actual permutation since 
// in any case the ans will be possible since ? is allowed to be either of ( and )
// but only case it will not be possible will be at extreme positions of ()
