...
const int _N = 2e+6 + 3;
//-------------------------------------------------------------------|
//basic math, just divide by highest denomination
//the quotient will represent the number of bills of that denomination
//and the remainder will represent the amount left, which needs to be made using lower denomination
int32_t main()
{
	fastio()
	int test = 1;
