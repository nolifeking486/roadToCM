...
// vertical increase by 2*levelNumber
// horizontal are added only when new level needs to be added
// sum of levels is just the sum of natural numbers
